...
async function getAccessToken() {
  ...
  if (!data.access_token) {
    ...
    console.error(msg);
    console.log(msg);
    // Write to a persistent log file in /home/site/wwwroot or /home/LogFiles
    try {
      fs.writeFileSync('/home/site/wwwroot/graph-token-error.json', JSON.stringify(data, null, 2));
    } catch (e) {
      try {
        fs.writeFileSync('/home/LogFiles/graph-token-error.json', JSON.stringify(data, null, 2));
      } catch (e2) {
        // If both fail, ignore
      }
    }
